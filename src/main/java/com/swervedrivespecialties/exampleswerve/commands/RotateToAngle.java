...
public class RotateToAngle extends Command {
  ...
  private PidController _pidController = new PidController(new PidConstants(0.007, 0, 0.0002));
  ...
  protected void execute() {
    ...
    _drivetrainSubsystem.holonomicDrive(new Vector2(0,0), 0.015 + _pidController.calculate(getMinAngleDiff(_drivetrainSubsystem.getGyroscope().getAngle().toDegrees(), _target), deltaTime), true);
